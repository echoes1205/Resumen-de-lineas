...
function App() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('http://localhost:8081/kutter');
  ...
  const update = async (id, datos) => {
    try {
      const response = await axios.put(`http://localhost:8081/kutter/${id}`, datos);
  ...
  return (
    ...
    <div className="tabla-lineas">
      <h1 className="title">Reporte de Kutter</h1>
